...
### Video Demo
[Link to YouTube/Google Drive video] - Shows app launch, location fetch, weather display, alert setup, and notification trigger (via time advance).

Built by TITH Tyratmonipich for DGC assignment.
